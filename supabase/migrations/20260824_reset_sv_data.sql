-- ============================================================
-- RaidDominion Portal — Reseteo de datos del flujo SV
-- Decisión de producto (2026-08-24): borra TODO lo derivado del
-- SavedVariables (uploads, personajes, hermandad/portal) y devuelve
-- el rol a visitante salvo staff. Conserva la cuenta, nombre
-- visible, slug y visibilidad. No toca auth.users ni otras apps.
-- ============================================================

-- ─── Resetear datos del flujo SV ────────────────────────────────────────
...
BEGIN
    ...
    -- saved_variables.guild_id es ON DELETE SET NULL, no las retiene)
